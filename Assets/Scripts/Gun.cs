...
public class Gun : MonoBehaviour
{
    ...
    protected void Fire()
    {
        ...
        Ray ray = Camera.main.ViewportPointToRay(new Vector3(0.5f, 0.5f, 0));  // Fires a ray out at the range of the gun
        RaycastHit hit;
        if(Physics.Raycast(ray, out hit, range))                           // If it collides with a GameObject, call processHit()
        {
